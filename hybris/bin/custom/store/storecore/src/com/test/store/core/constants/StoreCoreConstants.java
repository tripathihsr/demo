 ...
 */
package com.test.store.core.constants;

/**
 * Global class for all StoreCore constants. You can add global constants for your extension into this class.
 */
public final class StoreCoreConstants extends GeneratedStoreCoreConstants
{
	public static final String EXTENSIONNAME = "storecore";


	private StoreCoreConstants()
	{
		//empty
	}
