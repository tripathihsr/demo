 ...
 */
package com.test.store.core.suggestion;
...
import com.test.store.core.suggestion.impl.DefaultSimpleSuggestionService;
...
public class DefaultSimpleSuggestionServiceIntegrationTest extends ServicelayerTransactionalTest
{
	...
	{
		importCsv("/storecore/test/testSimpleSuggestionService.csv", "utf-8");
	}
