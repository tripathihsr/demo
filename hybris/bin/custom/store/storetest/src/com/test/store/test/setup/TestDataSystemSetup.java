 ...
 */
package com.test.store.test.setup;
...
import com.test.store.test.constants.StoreTestConstants;
import com.test.store.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = StoreTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/storetest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/storetest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/storetest/import/cstickets.impex");
			...
			importImpexFile(context, "/storetest/import/csquotes.impex");
		}
	}
}
