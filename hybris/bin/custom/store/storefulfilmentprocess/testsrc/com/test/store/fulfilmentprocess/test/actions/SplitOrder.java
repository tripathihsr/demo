 ...
 */
package com.test.store.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(StoreFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(StoreFulfilmentProcessConstants.PARENT_PROCESS);
