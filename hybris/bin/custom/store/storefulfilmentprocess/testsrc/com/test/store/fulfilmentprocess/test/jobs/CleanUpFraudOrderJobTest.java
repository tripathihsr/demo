 ...
 */
package com.test.store.fulfilmentprocess.test.jobs;
...
import com.test.store.fulfilmentprocess.jobs.CleanUpFraudOrderJob;
...
public class CleanUpFraudOrderJobTest extends ServicelayerTransactionalTest
{
	...
	private static final String PROCESS_DEFINITION_NAME = StoreFulfilmentProcessConstants.ORDER_PROCESS_NAME;
