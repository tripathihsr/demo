 ...
 */
package com.test.store.initialdata.setup;
...
import com.test.store.initialdata.constants.StoreInitialDataConstants;
 ...
 */
@SystemSetup(extension = StoreInitialDataConstants.EXTENSIONNAME)
